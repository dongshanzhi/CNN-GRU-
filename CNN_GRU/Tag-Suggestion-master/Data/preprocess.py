...
with open('vec100.txt', 'r') as fvec, open('testdata.txt', 'r') as ftest, open('trainingdata.txt', 'r') as ftrain, open(
        'MT_WordEmb.pkl', 'w') as fwe, open('ttrain.dialogues.pkl', 'w') as ftdia, open('tvalid.dialogues.pkl',
                                                                                        'w') as ftval, open(
        'ttrain.dict.pkl', 'w') as fdic:
